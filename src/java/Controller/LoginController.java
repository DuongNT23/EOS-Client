...
public class LoginController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(!e.checkExamCode()){
            request.setAttribute("error", "ExamCode is not existed!");
        ...
        if(!u.checkAccount()){
            request.setAttribute("error", "Wrong account or password! Please input again!");
            request.setAttribute("examCode", examCode);
            request.setAttribute("account", account);
            request.setAttribute("pass", pass);
            request.getRequestDispatcher("login.jsp").forward(request, response);
        }
        //get subjectId by exam code
        ...
        //lay du lieu cho servlet grading
        HttpSession s = request.getSession();
        s.setAttribute("subjectId", subjectId);
        s.setAttribute("examCode", examCode);
